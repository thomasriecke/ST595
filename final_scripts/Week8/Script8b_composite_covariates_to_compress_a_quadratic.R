...
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
n <- 40
flow <- rlnorm(n, 4, 0.25)  # change the mean and variance to predict local population dynamics in response to flow
...
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
alpha <- c(0, -2, -3)
beta <- c(0.15, -0.0015, 0.3, -0.004, 0.075)
...
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
invert <- rlnorm(n, alpha[1] + beta[1] * flow + beta[2] * flow^2, 0.1)
...
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
psi <- plogis(alpha[2] + beta[3]*flow + beta[4]*flow^2 + rnorm(n,0,0.25))
...
delta[1] <- -0.1
delta[2] <- -1
composite <- delta[1]*f + delta[2]*f*f
...
plot(N, ylab = 'Breeding pairs and hatched nests', ylim = c(0,1000), type = 'b')
points(h, pch = 19, type = 'b')

plot(N, ylab = 'Breeding pairs and recruits', ylim = c(0,1000), type = 'b')
